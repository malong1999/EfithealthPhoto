...
public class CaptureActivity extends AppCompatActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTakePicture = (FloatingActionButton) findViewById(R.id.take_picture);
        if (mTakePicture != null) {
            mTakePicture.setOnClickListener(mOnClickListener);
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (KeyEvent.KEYCODE_HEADSETHOOK == keyCode) { //按下了耳机键
            if (event.getRepeatCount() == 0) {  //如果长按的话，getRepeatCount值会一直变大
                ...
                Toast.makeText(this, "sdjfhkjsdhf", Toast.LENGTH_SHORT).show();
                //长按
            }
        }
...
//            Toast.makeText(MainActivity.this, "sdjfhkjsdhf", Toast.LENGTH_SHORT).show();
            if (action.equals(Intent.ACTION_HEADSET_PLUG)) {
                Toast.makeText(CaptureActivity.this, "651651", Toast.LENGTH_SHORT).show();
